...
public class StrategyConfig {
    ...
    public StrategyConfig(StrategyType type) {
        ...
        switch (type) {
            ...
            case VOLATILITY_BREAKOUT -> { stopLossPercent = BigDecimal.valueOf(30); targetPercent = BigDecimal.valueOf(80); maxIvRankForBuying = BigDecimal.valueOf(25); trailingStopActivationPercent = BigDecimal.valueOf(30); trailingGapPercent = BigDecimal.valueOf(15); minCombinedPremium = BigDecimal.valueOf(50); squareoffHour = 15; squareoffMinute = 0; scanTimeframe = "FIFTEEN_MINUTE"; candleTimeframe = "FIVE_MINUTE"; trendTimeframe = "FIFTEEN_MINUTE"; }
            ...
            case MOMENTUM -> { stopLossPercent = BigDecimal.valueOf(25); targetPercent = BigDecimal.valueOf(50); maxHoldMinutes = 30; trailingStopActivationPercent = BigDecimal.valueOf(15); trailingGapPercent = BigDecimal.valueOf(8); minCombinedPremium = BigDecimal.valueOf(40); squareoffHour = 15; squareoffMinute = 0; scanTimeframe = "FIVE_MINUTE"; candleTimeframe = "FIVE_MINUTE"; trendTimeframe = "FIFTEEN_MINUTE"; paperTrading = true; }
            case PREMIUM_SCALP -> { stopLossPercent = BigDecimal.valueOf(18); targetPercent = BigDecimal.valueOf(8); maxHoldMinutes = 25; trailingStopActivationPercent = BigDecimal.valueOf(6); trailingGapPercent = BigDecimal.valueOf(3); minCombinedPremium = BigDecimal.valueOf(200); squareoffHour = 15; squareoffMinute = 0; scanTimeframe = "FIVE_MINUTE"; candleTimeframe = "FIVE_MINUTE"; trendTimeframe = "FIFTEEN_MINUTE"; paperTrading = true; maxIvRankForBuying = BigDecimal.valueOf(22); }
            case BREAKOUT_REENTRY -> { stopLossPercent = BigDecimal.valueOf(7); targetPercent = BigDecimal.valueOf(12); maxHoldMinutes = 15; trailingStopActivationPercent = BigDecimal.valueOf(8); trailingGapPercent = BigDecimal.valueOf(4); minCombinedPremium = BigDecimal.valueOf(50); squareoffHour = 14; squareoffMinute = 30; scanTimeframe = "FIVE_MINUTE"; candleTimeframe = "FIVE_MINUTE"; trendTimeframe = "FIFTEEN_MINUTE"; paperTrading = true; maxIvRankForBuying = BigDecimal.valueOf(40); }
        }
    }
