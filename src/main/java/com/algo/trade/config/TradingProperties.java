...
public record TradingProperties(
    ...
    public record Broker(
        ...
        public static Broker defaults() {
            return new Broker(BrokerName.ZERODHA, "", "", "", "", "https://api.kite.trade",
                    ...
                    "http://localhost:8089/advalgotrade/me/broker/kite/callback",
                    "/me/broker/kite/callback", Duration.ofSeconds(5), true, false, "ngrok.exe", 8089,
    ...
    public record Risk(
        ...
        public static Risk defaults() {
            return new Risk(BigDecimal.valueOf(80_000), BigDecimal.valueOf(20), BigDecimal.valueOf(60),
                    10, 10, 2, 1, BigDecimal.valueOf(3), 0, BigDecimal.ZERO);
        }
    }
