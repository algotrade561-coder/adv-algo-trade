...
public class BacktestCsvExporter {
    ...
    private String metricsCsv(BacktestRunResult result) {
        ...
        return "metric,value\n"
                ...
                + "signalConversionPercent," + metrics.signalConversionPercent() + '\n'
                + "totalSignals," + metrics.totalSignals() + '\n'
                + "rejectedSignals," + metrics.rejectedSignals() + '\n'
                + "skippedWhileInTrade," + metrics.skippedWhileInTrade() + '\n';
    }
    ...
    private String html(BacktestRunResult result) {
        ...
        return "<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'>"
                ...
                + card("Profit Factor", formatMoney(m.profitFactor()), m.profitFactor().compareTo(java.math.BigDecimal.ONE) >= 0 ? "#16a34a" : "#dc2626")
                + card("Risk:Reward", formatMoney(m.riskRewardRatio()), null)
                + card("Avg Hold", formatMoney(m.avgHoldMinutes()) + " min", null)
                + card("Max Consec Wins", String.valueOf(m.maxConsecutiveWins()), "#16a34a")
                + card("Max Consec Losses", String.valueOf(m.maxConsecutiveLosses()), "#dc2626")
                + card("Total Signals", String.valueOf(m.totalSignals()), "#6366f1")
                + card("Conversion", m.signalConversionPercent().setScale(1, java.math.RoundingMode.HALF_UP) + "%", null)
                + card("Rejected (Zero Qty)", String.valueOf(m.rejectedSignals()), m.rejectedSignals() > 0 ? "#f59e0b" : null)
                + card("Skipped (In Trade)", String.valueOf(m.skippedWhileInTrade()), m.skippedWhileInTrade() > 0 ? "#8b5cf6" : null)
                + "</div>"
