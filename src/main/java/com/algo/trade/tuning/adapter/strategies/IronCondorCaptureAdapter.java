...
@Component
public class IronCondorCaptureAdapter extends AbstractSpreadCaptureAdapter {
    @Override public StrategyType strategy() { return StrategyType.IRON_CONDOR; }
    @Override public List<BucketDimension> bucketDimensions() {
        return List.of(
                numericRange("ivRank", "ivRank", List.of(40.0, 50.0, 60.0, 70.0)).getFirst(),
                numericRange("wingDistance", "wingDistance", List.of(50.0, 100.0, 150.0, 200.0)).getFirst(),
