...
public class StrategyConfig {
    ...
    public StrategyConfig(StrategyType type) {
        ...
        switch (type) {
            ...
            case SCALPING -> { stopLossPercent = BigDecimal.valueOf(20); targetPercent = BigDecimal.valueOf(40); maxHoldMinutes = 15; trailingStopActivationPercent = BigDecimal.valueOf(10); trailingGapPercent = BigDecimal.valueOf(10); minCombinedPremium = BigDecimal.valueOf(70); squareoffHour = 14; squareoffMinute = 30; scanTimeframe = "FIVE_MINUTE"; candleTimeframe = "FIVE_MINUTE"; trendTimeframe = "FIVE_MINUTE"; }
