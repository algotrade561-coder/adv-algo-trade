...
class RuleBasedOptionsStrategyTest {
    ...
    void blocksPutEntryWhenUnderlyingTrendIsNotBearish() {
        ...
        // PE on bullish underlying: VWAP fails (soft, -15 pts) + OI doesn't support PE
        // → confidence score too low to pass threshold → NO_TRADE
        assertThat(decision.signalType()).isEqualTo(SignalType.NO_TRADE);
        assertThat(decision.reasons()).contains("Trend condition failed");
    }
