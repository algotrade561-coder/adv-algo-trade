...
class TuningCaptureControllerTest {
    ...
    void listStrategies_returnsRowForEveryStrategyType_evenWhenUnseeded() {
        ...
        // Anything other than OI_MOMENTUM falls back to the default snapshot,
        // which is ON as of 4 Jun 2026 (capture enabled by default for fresh rows).
        assertThat(rows).filteredOn(r -> !r.strategy().equals("OI_MOMENTUM"))
                .allSatisfy(r -> assertThat(r.captureEnabled()).isTrue());
    }
