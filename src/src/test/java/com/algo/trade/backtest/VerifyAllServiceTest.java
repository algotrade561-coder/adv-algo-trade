...
class VerifyAllServiceTest {
    ...
    class EngineDelegation {
        ...
        void singleLegStrategiesUseBacktestEngine() {
            ...
            // (ITM_CONVICTION and OI_MOMENTUM are live-only, skipped in backtest; MEAN_REVERSION is single-leg)
        ...
        void spreadNeverDelegatedToSingleLeg() {
            ...
            // We verify the total call count is exactly 22 (11 backtestable strategies × 2 option types).
            // ITM_CONVICTION and OI_MOMENTUM are live-only, skipped; MEAN_REVERSION is single-leg.
            service.verifyAll(VerifyAllRequest.defaults());
